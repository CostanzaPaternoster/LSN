...
SimulatedAnnealing :: SimulatedAnnealing(int init_shuffle, double pmutation, double beta0, double deltabeta){
...
void SimulatedAnnealing :: Print(int step,Individual ind){
    
    ind.PrintInd(step);
    
    ofstream print;
    if(ind.geometry) print.open("Temp/Circle/fitness.dat",ios::app);
    else print.open("Temp/Square/fitness.dat",ios::app);
    
    print.precision(1);
    print << fixed << beta;
    print.precision(3);
    print << setw(8) << ind.SelfFitness() << endl;
